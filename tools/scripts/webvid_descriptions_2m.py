...
def parse_args():
    ...
    parser.add_argument("--chunk", type=int, default=0, help="specify the chunk to process.")
    parser.add_argument(
        "--options",
        nargs="+",
...
video_path = "path_to/datasets/WebVid/2M/train/{}".format(chunk)

save_dir = "path_to/datasets/WebVid/2M/frames"

caption_path = "path_to/datasets/WebVid/2M/captions_13B_vicuna/{}.csv".format(chunk)
success_videos = "path_to/datasets/WebVid/2M/captions_13B_vicuna/success_{}.txt".format(chunk)
